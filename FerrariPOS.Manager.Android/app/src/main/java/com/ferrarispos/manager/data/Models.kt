...
data class ProductWrite(val barcode:String,val description:String,val salePrice:Double,val wholesalePrice:Double,val costPrice:Double,val stock:Double,val minStock:Double,val category:String,val unit:String,val bulk:Boolean,val usesInventory:Boolean,val iva21:Boolean=false)
...
data class PurchaseDetail(val id:Long=0,val orderNo:String="",val supplierId:Int=0,val supplier:String="",val status:String="",val notes:String="",val items:List<PurchaseDetailItem> = emptyList())
