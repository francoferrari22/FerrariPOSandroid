...
echo GitHub compilara Android + Windows y entregara DOS ARTEFACTOS INDEPENDIENTES.
echo.
set "REPO="
...
echo Resultado: FerrariPOS-Manager-Android y FerrariPOS-Manager-Windows-COMPLETO
echo ================================================================
pause
endlocal
