...
echo Al final tendras el artefacto: FERRARI-POS-MANAGER-ANDROID-WINDOWS-COMPLETO
echo ================================================================
pause
endlocal
